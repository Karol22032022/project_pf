...
export function FourSteps(){
    return(
        <section className="four_steps_section_one">
        <div className="steps_text">
            <p className="steps_param">Wystarczą 4 proste kroki</p>
            <img src="https://firebasestorage.googleapis.com/v0/b/test-space-d850c.appspot.com/o/Decoration.svg?alt=media&token=1c2c8f64-bc39-4175-a2c8-99a82911b539"/>
        </div>
            <div className="steps_pictures">
                <div className="steps_picture_one">
                    <img src="https://firebasestorage.googleapis.com/v0/b/test-space-d850c.appspot.com/o/Icon-1.svg?alt=media&token=4016144e-56a8-492c-be31-68e011b3ab3b"/>
                ...
                <div className="steps_picture_two">
                    <img src="https://firebasestorage.googleapis.com/v0/b/test-space-d850c.appspot.com/o/Icon-2.svg?alt=media&token=227d2ad9-e123-47cd-9e81-b5d3f568be41"/>
                ...
                <div className="steps_picture_three">
                    <img src="https://firebasestorage.googleapis.com/v0/b/test-space-d850c.appspot.com/o/Icon-3.svg?alt=media&token=2aae77ea-8c22-4498-84ee-5eddb3337666"/>
                ...
                <div className="steps_picture_four">
                    <img src="https://firebasestorage.googleapis.com/v0/b/test-space-d850c.appspot.com/o/Icon-4(1).svg?alt=media&token=b350ca45-53ed-4b82-a8cb-143630a993f4"/>
